...
#Punto 9.d Analisis HRV en tiempo
mean_rr = np.mean(rr_intervals_sec) #Intervslo de datos
sdnn = np.std(rr_intervals_sec) # Desvicion estandasr intervalos

print(f"Intervalo R-R promedio: {mean_rr * 1000:.2f} ms") #Promedio de intervalos
print(f"Desviacion estandar Intervalo R-R: {sdnn * 1000:.2f} ms")



#Aplicación Transformada de Wavelet Punto e
